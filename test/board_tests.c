...
int main(void) {
  ...
  EXPECT(board_player(board_1) == EMPTY_DISC, "board_player() == EMPTY_DISC");
  board_free(board_1);
  ...
  EXPECT(board_player(board_2) == BLACK_DISC, "board_player() == BLACK_DISC");
  board_free(board_2);
  ...
  EXPECT(board_player(board_3) == BLACK_DISC, "board_player() == BLACK_DISC");
  board_free(board_3);
  ...
  EXPECT(board_player(board_4) == BLACK_DISC, "board_player() == BLACK_DISC");
  board_free(board_4);
  ...
  EXPECT(board_player(board_5) == BLACK_DISC, "board_player() == BLACK_DISC");
  board_free(board_5);
  ...
  /* Checking board_count_opponent_moves() */
  EXPECT(board_count_opponent_moves(board_4) == 4,
         "board_count_opponent_moves(board) == 4");

  /* Checking board_next_move() */
  move_t tmp_move = board_next_move(board_4);
  EXPECT(tmp_move.row == 5 && tmp_move.column == 1,
         "board_next_move() == { 5, 1 }");

  tmp_move = board_next_move(board_4);
  EXPECT(tmp_move.row == 5 && tmp_move.column == 2,
         "board_next_move() == { 5, 2 }");

  tmp_move = board_next_move(board_4);
  EXPECT(tmp_move.row == 5 && tmp_move.column == 3,
         "board_next_move() == { 5, 3 }");

  tmp_move = board_next_move(board_4);
  EXPECT(tmp_move.row == 5 && tmp_move.column == 4,
         "board_next_move() == { 5, 4 }");

  tmp_move = board_next_move(board_4);
  EXPECT(tmp_move.row == 5 && tmp_move.column == 5,
         "board_next_move() == { 5, 5 }");

  tmp_move = board_next_move(board_4);
  EXPECT(tmp_move.row == 5 && tmp_move.column == 1,
         "board_next_move() == { 5, 1 } (again!)");

  /* Checking board_is_move_valid() */
  EXPECT(!board_is_move_valid(board_4, (move_t){5, 0}),
         "board_is_move_valid(5,0) == false");

  EXPECT(board_is_move_valid(board_4, (move_t){5, 1}),
         "board_is_move_valid(5,1) == true");

  EXPECT(board_is_move_valid(board_4, (move_t){5, 2}),
         "board_is_move_valid(5,2) == true");

  EXPECT(board_is_move_valid(board_4, (move_t){5, 3}),
         "board_is_move_valid(5,3) == true");

  EXPECT(board_is_move_valid(board_4, (move_t){5, 4}),
         "board_is_move_valid(5,4) == true");

  EXPECT(board_is_move_valid(board_4, (move_t){5, 5}),
         "board_is_move_valid(5,5) == true");
  ...
  /* Checking board_count_opponent_moves() */
  EXPECT(board_count_opponent_moves(board_5) == 5,
         "board_count_opponent_moves(board) == 5");
  ...
  tmp_move = board_next_move(board_5);
  EXPECT(tmp_move.row == 2 && tmp_move.column == 4,
         "board_next_move() == { 2, 4 }");

  tmp_move = board_next_move(board_5);
  EXPECT(tmp_move.row == 3 && tmp_move.column == 3,
         "board_next_move() == { 3, 3 }");

  tmp_move = board_next_move(board_5);
  EXPECT(tmp_move.row == 6 && tmp_move.column == 2,
         "board_next_move() == { 6, 2 }");

  tmp_move = board_next_move(board_5);
  EXPECT(tmp_move.row == 6 && tmp_move.column == 3,
         "board_next_move() == { 6, 3 }");

  tmp_move = board_next_move(board_5);
  EXPECT(tmp_move.row == 6 && tmp_move.column == 4,
         "board_next_move() == { 6, 4 }");

  tmp_move = board_next_move(board_5);
  EXPECT(tmp_move.row == 6 && tmp_move.column == 5,
         "board_next_move() == { 6, 5 }");

  tmp_move = board_next_move(board_5);
  EXPECT(tmp_move.row == 6 && tmp_move.column == 6,
         "board_next_move() == { 6, 6 }");

  tmp_move = board_next_move(board_5);
  EXPECT(tmp_move.row == 2 && tmp_move.column == 3,
         "board_next_move() == { 2, 3 } (again!)");
  ...
  EXPECT(board_play(board_4, (move_t){5, 5}), "board_play(5,5) == true");
  ...
  EXPECT(board_play(board_4, (move_t){1, 3}), "board_play(1,3) == true");
  ...
  EXPECT(board_play(board_4, (move_t){3, 2}), "board_play(3,2) == true");
  ...
  EXPECT(board_play(board_4, (move_t){4, 5}), "board_play(4,5) == true");
  ...
  EXPECT(!board_play(board_4, (move_t){0, 0}), "board_play(0,0) == false");
  ...
  EXPECT(board_play(board_2, (move_t){3, 3}), "board_play(3,3) == true");
